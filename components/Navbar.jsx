    ...
    return (
        <nav className="sticky top-0 z-10 bg-white shadow-xl dark:text-white dark:bg-gray-900">
            <div className="container flex flex-row h-16 px-6 py-2">
                <div className="flex flex-row items-center pr-3 md:hidden">
            ...
            <div className={`fixed bottom-0 shadow-2xl left-0 w-64 transition-inset dark:bg-gray-800 top-16  bg-teal-600 duration-300 py-4 md:-left-72 ${Isside ? "left-0" : "-left-72"}`}>
                <ul>
