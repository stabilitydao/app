                ...
                <ul className="p-4 lg:p-8 ">
                    <li>
                        <article className="mb-4">
                            <a className="p-4 lg:p-6 ">
                                ...
                                <div>
                                    <img src="/profit.svg" alt="profit" width="100" className="float-left ml-3 mr-7 my-2" />
                                    <p className="text-lg">
                    ...
                    <li>
                        <article>
                            ...
                            <table className="table-auto bg-blend-darken lg:mx-8 text-sm md:text-xl">
                                <thead>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td className="py-1 text-center font-bold">97%</td>
                                ...
                                <tr>
                                    ...
                                    <td className="py-1 text-center font-bold">2.5%</td>
                                ...
                                <tr>
                                    ...
                                    <td className="py-1 text-center font-bold">0.5%</td>
