                                ...
                                <div className="flex flex-wrap">
                                    <div className="w-full mb-4 lg:w-1/2 lg:mb-0">
                                        ...
                                        <p className="text-sm text-center text-cool-gray-500">
                                            {networks && networks[chainId ? chainId :currentNetwork] ? (
                                                <a title="View Asset on Etherscan" target="_blank" href={networks[currentNetwork].explorer.concat("/address/").concat(addresses[currentNetwork].token)} rel="noopener noreferrer">{addresses[currentNetwork].token}</a>
                                            ) : null}
                                        </p>
                                    </div>
