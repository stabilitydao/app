                                    ...
                                    <div className="w-full lg:w-1/2 mb-4 lg:mb-0">
                                        ...
                                        <p className="text-sm text-center text-cool-gray-500">
                                            {networks && networks[currentNetwork] ? (
                                                <a title="View Asset on Etherscan" target="_blank" href={networks[currentNetwork].explorer.concat("/address/").concat(addresses[currentNetwork].token)}>{addresses[currentNetwork].token}</a>
                                            ) : null}
                                        </p>
                                    </div>
