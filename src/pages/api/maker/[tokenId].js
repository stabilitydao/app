...
import addresses, {POLYGON,} from "@stabilitydao/addresses";
...
export default async function handler(request, response) {
    ...
    const pmAddress = addresses[POLYGON].pm;

    const dbKey = `PROFIT_MAKER_1_${tokenId}`
    const usedColorsDbKey = 'PROFIT_MAKER_USED_COLORS_1'

    const HOST = 'https://stabilitydao.org'
    ...
    if (dbMetaData) {
        ...
        const web3 = new Web3(new Web3.providers.HttpProvider(networks[POLYGON].rpc))
